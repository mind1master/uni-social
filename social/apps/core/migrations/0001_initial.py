...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_socialuser', (
        ...
        db.send_create_signal(u'core', ['SocialUser'])


    def backwards(self, orm):
        
        # Deleting model 'SocialUser'
        db.delete_table(u'core_socialuser')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 18, 7, 22, 5, 476737)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 18, 7, 22, 5, 475973)'}),
        ...
        u'core.socialuser': {
            'Meta': {'object_name': 'SocialUser', '_ormbases': [u'auth.User']},
